...
void main() {
  ...
  var user1 = BankAccount("12345", "Alice", "Savings");
  var user2 = BankAccount("75638", "Bob", "Checking");
  var user3 = BankAccount("54321", "Charlie", "Savings");

  user1.deposit(1000.0);
  user2.deposit(500.0);
  user3.deposit(2000.0);

  user1.withdraw(200.0);
  user2.withdraw(100.0);
