...
mixin Payable {
  ...
  void processPayment(double amount) {
    ...
    print("Payment Processes: $amount");
  }
}
...
void main() {
  ...
  var manager = Manager("Biozid Tonoy", "M001", "IT", 5);
  var developer = Developer("Jhon doe", "D001", "IT", "Dart");
  ...
  double developerSalary =
      developer.calculateSalary(developer.getBaseSalary(), 1000.0);
